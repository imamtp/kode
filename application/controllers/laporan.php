...
class laporan extends MY_Controller {
    ...
    public function salesbookdetail(){

    }

    public function deliveryvsactualdate(){
...
//        print_r($pengeluaranlain);
        ...
        $tax = $this->db->get_where('unit',array('idunit'=>$idunit))->row();
...
//        print_r($report);
    ...
    function ARSales()
    {
        ...
        $this->load->view('report/ar/sales', $data);
    }
...
//            echo $this->db->last_query();
    ...
    function pengeluaranTahun($idunit=null,$tahun,$option=null)
    {
        ...
        $q = $this->db->query("select idaccount,idunit,accnumber,accname
            ...
            AND idparent IN (select idaccount from account 
