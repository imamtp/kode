...
//         echo $this->db->last_query();
    ...
    function saveNewBalance($idaccount,$balance,$idunit)
    {
...
//        $q->free_result();        
    ...
    function saveAccountLog($idunit,$idaccount,$credit,$debit,$date,$idjournal=null)
    {
        $d = array(
                    "idaccount"=>$idaccount,
                    "credit" =>$credit,
        ...
        $arrWer = array('idaccount'=>$idaccount, 'tanggal'=>$date, 'idjournal'=>$idjournal, 'userid'=>$this->session->userdata('userid'), 'idunit'=>$idunit);
