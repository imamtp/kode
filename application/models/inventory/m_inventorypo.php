...
class m_inventorypo extends CI_Model {
    ...
    function selectField() {
        return "a.nopurchase,z.qty,i.idunit,i.idinventory,i.invno,i.nameinventory,i.description,i.isinventory,i.issell,
            i.isbuy,i.cosaccount,i.incomeaccount,i.assetaccount,i.qtystock,i.images,i.cost,
            i.unitmeasure,i.numperunit,i.minstock,i.idprimarysupplier,i.sellingprice,a.idunit";
    }
    ...
    function query() {
        $query = "select " . $this->selectField() . "
                ...
                . "join purchase a ON z.idpurchase = a.idpurchase
                    ...
                    join inventory i ON z.idinventory = i.idinventory";
