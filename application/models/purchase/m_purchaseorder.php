...
class m_purchaseorder extends CI_Model {
    ...
    function whereQuery() {
        ...
        if($this->input->post('option')=='notyetdelivered'){
            $wer = " and a.delivereddate is null and a.idpurchasestatus = 2";
