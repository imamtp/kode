...
Ext.define('TransactionGridModel', {
    ...
    fields: [
       'id_saving_history','id_saving_type','id_member','idunit','idjournal','datein','tellerid','approvedby','amount','fee_adm','status','trx_type','id_saving_type_dest','id_member_dest','remarks','trx_time_type','trx_date','member_name','no_member','username','saving_name'
    ],
    idProperty: 'id'
});
...
Ext.define(dir_sys + 'saving.TransactionGrid', {
    ...
    columns: [{
        ...
        },
        {
            ...
            minWidth: 100,
            renderer: function(value) {
                return customColumnStatus(DepositStatusArr, value);
            }
        },
        {
            header: 'No Anggota',
