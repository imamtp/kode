//acc list
Ext.define('GridCOABayarHutangPopup', {
    itemId: 'GridCOABayarHutangPopup',
    id: 'GridCOABayarHutangPopup',
    extend: 'Ext.grid.Panel',
    alias: 'widget.GridCOABayarHutangPopup',
    ...
    columns: [{
            ...
            handler: function(grid, rowIndex, colIndex, actionItem, event, selectedRecord, row) {
                setValueAcc(selectedRecord, 'wCoaKasBayarHutang', 'BayarHutang');
            }
        },
...
Ext.define(dir_sys + 'money.wCoaKasBayarHutang', {
    extend: 'Ext.window.Window',
    id: 'wCoaKasBayarHutang',
    alias: 'widget.wCoaKasBayarHutang',
