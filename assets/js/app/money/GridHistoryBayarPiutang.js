Ext.define('GridHistoryBayarPiutangModel', {
    ...
    fields: ['idpiutanghistory','idregistrasipiutang','tanggal','diterima','sisa','idjournal','datein','namaunit','accnamepiutang','namecustomer','nocustomer','accnumberlink','accname'],
    idProperty: 'id'
});
...
Ext.define(dir_sys + 'money.GridHistoryBayarPiutang', {
    ...
    loadMask: true,
    columns: [
        {header: 'No Trans', dataIndex: 'idpiutanghistory'},
        {header: 'idregistrasipiutang', dataIndex: 'idregistrasipiutang', hidden: true},
        {header: 'Nama Konsumen', dataIndex: 'namecustomer', minWidth: 200, flex:1},
        {header: 'No Konsumen', dataIndex: 'nocustomer', minWidth: 200},
        {header: 'Tgl Penerimaan', dataIndex: 'tanggal', minWidth: 150},
        // {header: 'date trans', dataIndex: 'datetrans', minWidth: 100},
        // {header: 'memo', dataIndex: 'memo', minWidth: 200,flex:1},
        {header: 'Jumlah Penerimaan', dataIndex: 'diterima', minWidth: 150, xtype: 'numbercolumn', align: 'right'},
        {header: 'Saldo Hutang', dataIndex: 'sisa', minWidth: 150, xtype: 'numbercolumn', align: 'right'},
        {header: 'Akun Piutang', dataIndex: 'accname', minWidth: 150},
        {header: 'Akun Penerimaan Kas', dataIndex: 'accnamepiutang', minWidth: 200},
        {header: 'Waktu Transaksi', dataIndex: 'datein', minWidth: 150}
    ]
    , dockedItems: [
        {
            xtype: 'toolbar',
