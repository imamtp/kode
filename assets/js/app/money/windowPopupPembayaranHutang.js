var wCoaKasBayarHutang = Ext.create(dir_sys + 'money.wCoaKasBayarHutang');
                ...
                if (form.isValid()) {
                    form.submit({
                        success: function(form, action) {
                            ...
                            Ext.getCmp('GridRegHutangID').getStore().load();
                        },
...
Ext.define(dir_sys + 'money.windowPopupPembayaranHutang', {
    extend: 'Ext.window.Window',
    alias: 'widget.windowPopupPembayaranHutang',
