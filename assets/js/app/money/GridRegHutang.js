var windowPopupPembayaranHutang = Ext.create(dir_sys + 'money.windowPopupPembayaranHutang');
...
Ext.define(dir_sys + 'money.GridRegHutang', {
    extend: 'Ext.grid.Panel',
                ...
                },
                {
                    ...
                    handler: function() {
                        ...
                        if (data.length == 0) {
                            ...
                            windowPopupPembayaranHutang.show();
