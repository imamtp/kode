...
Ext.define('WOMaterialUsageGridModel', {
    ...
    fields: [
        'job_order_id','idsales','idunit','startdate_job','material_datein','enddate_job','job_no','req_ship_date','status','remarks','datesales','no_sales_order','date_sales','totaljob','totalraw','totalbom','firstname'
    ],
    idProperty: 'id'
});
