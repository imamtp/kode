Ext.define('SalesInvoiceOverdueGridModel', {
    ...
    fields: [
       'idsales','no_sales_order','subtotal','freight','date_sales','tax','disc','totalamount','Overduetoday','balance','comments','noinvoice','ddays','eomddays','percentagedisc','daydisc','notes_si','nocustomer','namecustomer','idpayment','invoice_status','invoice_date'
    ],
    idProperty: 'id'
});
    ...
    dockedItems: [
     {
            ...
            items:[
                ...
                },'-',
                {
                    xtype:'comboxunit',
                    valueField:'idunit',
                    id:'cbSalesInvoiceOverdue',
                    listeners: {
                        'change': function(field, newValue, oldValue) {
                            storeGridSalesInvoiceOverdueGrid.load({
                                params: {
                                  'extraparams': 'a.idunit:'+Ext.getCmp('cbSalesInvoiceOverdue').getValue()+','+'a.idanggotatype:'+Ext.getCmp('cbUnitPelangganType').getValue()
