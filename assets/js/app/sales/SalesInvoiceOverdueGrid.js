Ext.define('SalesInvoiceOverdueGridModel', {
    ...
    fields: [
        'idsales', 'no_sales_order', 'subtotal', 'freight', 'date_sales', 'tax', 'disc', 'totalamount', 'Overduetoday', 'balance', 'comments', 'noinvoice', 'ddays', 'eomddays', 'percentagedisc', 'daydisc', 'notes_si', 'nocustomer', 'namecustomer', 'idpayment', 'invoice_status', 'invoice_date', 'term', 'duedate'
    ],
    idProperty: 'id'
});
...
storeGridSalesInvoiceOverdueGrid.on('beforeload', function(store, operation, eOpts) {
    operation.params = {
        'extraparams': 'a.invoice_status:' + 3 + ', ' +
            'a.idunit:' + Ext.getCmp('idunit_grdsi_od').getValue(),
