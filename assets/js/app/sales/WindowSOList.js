...
storeGridSalesOrderList.on('beforeload', function(store, operation, eOpts) {
    operation.params = {
...
Ext.define(dir_sys + 'sales.WindowSOList', {
    extend: 'Ext.window.Window',
    alias: 'widget.WindowSOList',
    id: 'WindowSOList',
