//acc list
Ext.define('GridCOAPaymentSalesPopup', {
    itemId: 'GridCOAPaymentSalesPopup',
    id: 'GridCOAPaymentSalesPopup',
    extend: 'Ext.grid.Panel',
    alias: 'widget.GridCOAPaymentSalesPopup',
    ...
    columns: [{
            ...
            handler: function(grid, rowIndex, colIndex, actionItem, event, selectedRecord, row) {
                setValueAcc(selectedRecord, 'wCoaSalesPaymentPopup', '_coa_paymentsales');
            }
        },
...
Ext.define(dir_sys + 'sales.wCoaSalesPaymentPopup', {
    extend: 'Ext.window.Window',
    id: 'wCoaSalesPaymentPopup',
    alias: 'widget.wCoaSalesPaymentPopup',
    title: 'Pilih Akun',
    header: {
        titlePosition: 2,
        titleAlign: 'center'
    ...
    border: false,
    items: [{
        xtype: 'GridCOAPaymentSalesPopup'
    }]
});