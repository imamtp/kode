...
function showSalesOrderData(record) {
    ...
    if (record.data.idsales_quote === null) {
        Ext.getCmp('is_from_sq_soform').setValue({
            is_from_sq: 2
        });
    } else {
        Ext.getCmp('is_from_sq_soform').setValue({
    ...
    Ext.getCmp('delivery_date_SalesOrder').setValue(record.data.delivery_date_sales);
    ...
    Ext.getCmp('diskonSalesOrder').setValue(disc.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
    Ext.getCmp('freightSalesOrder').setValue(freight.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
    Ext.getCmp('dppSalesOrder').setValue(dpp.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
    Ext.getCmp('subtotalSalesOrder').setValue(subtotal.toLocaleString('null', {
        minimumFractionDigits: 2
    }));
    Ext.getCmp('totalPajakSalesOrder').setValue(tax.toLocaleString('null', {
        minimumFractionDigits: 2
    }));
    Ext.getCmp('totalSalesOrder').setValue(totalamount.toLocaleString('null', {
        minimumFractionDigits: 2
    }));
}
...
function showSalesQuotationData(record) {
    ...
    var tax = record.data.tax * 1;
    var totalamount = record.data.totalamount * 1;
    Ext.getCmp('subtotalSalesQuotation').setValue(subtotal.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
    Ext.getCmp('totalPajakSalesQuotation').setValue(tax.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
    Ext.getCmp('totalSalesQuotation').setValue(totalamount.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
...
function loadDataFormInvoiceDO(delivery_order_id) {
    Ext.Ajax.request({
        ...
        success: function(form, action) {
            ...
            Ext.getCmp('discountSalesInvoice_si').setValue(disc.toLocaleString('null', {
                maximumFractionDigits: 2
            }));
            Ext.getCmp('dppSalesInvoice_si').setValue(dpp.toLocaleString('null', {
                maximumFractionDigits: 2
            }));
            ...
            Ext.getCmp('cb_tax_id_inv').setValue(d.data.nametax);
            Ext.getCmp('subtotalSalesInvoice_si').setValue(subtotal.toLocaleString('null', {
                maximumFractionDigits: 2
            }));
            Ext.getCmp('angkutSalesInvoice_si').setValue(freightcost.toLocaleString('null', {
                maximumFractionDigits: 2
            }));
            Ext.getCmp('totalSalesInvoice_si').setValue(totalamount.toLocaleString('null', {
                maximumFractionDigits: 2
            }));
            Ext.getCmp('totalPajakSalesInvoice_si').setValue(tax.toLocaleString('null', {
                maximumFractionDigits: 2
            }));
            Ext.getCmp('sisaBayarSalesInvoice_si').setValue(totalamount.toLocaleString('null', {
                maximumFractionDigits: 2
            }));
...
var windowPopupWindowSalesPayment = Ext.create('widget.window', {
    ...
    items: [{
        ...
        items: [{
            ...
            id: 'sales_invoice_id_paymentsales'
        },{
            xtype: 'hiddenfield',
            name: 'idsales',
...
function windowSalesPayment(data) {
  ...
  console.log(data);
    ...
    Ext.getCmp('sales_invoice_id_paymentsales').setValue(data.sales_invoice_id);    
    ...
    Ext.getCmp('balance_sales_paymentsales').setValue(renderNomor3(data.balance));
...
function clearFormSQ() {
    ...
    Ext.each(EntrySalesQuotation.getRange(), function() {
        EntrySalesQuotation.removeAt(0);
    });
}
...
function clearFormSO() {
    ...
    Ext.each(storeGridItemSalesOrder.getRange(), function() {
        storeGridItemSalesOrder.removeAt(0)
    });
}
...
function updateGridSalesOrder(tipe) {
    ...
    // alert(totalPajak);
    Ext.getCmp('subtotal' + addprefix).setValue(subtotalSalesOrder.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
    Ext.getCmp('total' + addprefix).setValue(totalSalesOrder.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
    Ext.getCmp('totalPajak' + addprefix).setValue(totalPajak.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
    Ext.getCmp('diskonSalesOrder').setValue(total_diskon.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
    Ext.getCmp('dppSalesOrder').setValue(dppSalesOrder.toLocaleString('null', {
        maximumFractionDigits: 2
    }));
...
function updateGridSalesQuotation() {
    ...
    Ext.getCmp('subtotal' + addprefix).setValue(subtotalSalesQuotation.toLocaleString('null', {
        minimumFractionDigits: 2
    }));
    Ext.getCmp('total' + addprefix).setValue(totalSalesQuotation.toLocaleString('null', {
        minimumFractionDigits: 2
    }));
    Ext.getCmp('totalPajak' + addprefix).setValue(totalPajak.toLocaleString('null', {
        minimumFractionDigits: 2
    }));
    Ext.getCmp('angkut' + addprefix).setValue(angkutSalesQuotation.toLocaleString('null', {
        minimumFractionDigits: 2
    }));
