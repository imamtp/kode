    ...
    dockedItems: [{
        ...
        items: [{
            ...
            handler: function() {
                ...
                Ext.getCmp('dateTransferStock').setValue(null);
                Ext.getCmp('memoTransferStock').setValue(null);
                Ext.getCmp('transfer_stock_id').setValue(null);
                Ext.getCmp('no_trans_transfer_inv').setValue(null);
                Ext.getCmp('no_trans_transfer_inv').setReadOnly(false);
                storeGridInventoryTransferPopUp.load({
                    params: {
                        transfer_stock_id: 90909090000
                    }
                });
            }
        }, {
