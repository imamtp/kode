//acc list
Ext.define('GridCOAPaymentPurchasePopup', {
    itemId: 'GridCOAPaymentPurchasePopup',
    id: 'GridCOAPaymentPurchasePopup',
    extend: 'Ext.grid.Panel',
    alias: 'widget.GridCOAPaymentPurchasePopup',
    ...
    columns: [
    {
            ...
            handler: function(grid, rowIndex, colIndex, actionItem, event, selectedRecord, row) {
               setValueAcc(selectedRecord,'wCoaPurchasePaymentPopup','_coa_purchasepayment');
            }
        },
...
Ext.define(dir_sys + 'purchase2.wCoaPurchasePaymentPopup', {
    extend: 'Ext.window.Window',
    id: 'wCoaPurchasePaymentPopup',
    alias: 'widget.wCoaPurchasePaymentPopup',
    title: 'Pilih Akun',
    header: {
        titlePosition: 2,
        titleAlign: 'center'
...
//    autoWidth: true,
    ...
    border: false,
    items: [{
            xtype:'GridCOAPaymentPurchasePopup'
    }]
});