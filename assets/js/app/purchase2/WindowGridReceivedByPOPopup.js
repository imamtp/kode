...
Ext.define('GridReceivedByPOPopup', {
    itemId: 'GridReceivedByPOPopupID',
    id: 'GridReceivedByPOPopupID',
    ...
    columns: [
        {
            ...
            handler: function(grid, rowIndex, colIndex, actionItem, event, selectedRecord, row) {
                ...
                Ext.getCmp('receivedid_poreceipt').setValue(selectedRecord.get('idemployee'));
                Ext.getCmp('received_poreceipt').setValue(selectedRecord.get('firstname')+' '+selectedRecord.get('lastname'));
                Ext.getCmp('WindowGridReceivedByPOPopup').hide();
...
Ext.define(dir_sys + 'purchase2.WindowGridReceivedByPOPopup', {
    extend: 'Ext.window.Window',
    alias: 'widget.WindowGridReceivedByPOPopup',
    id: 'WindowGridReceivedByPOPopup',
    title: 'Received By',
    header: {
        titlePosition: 2,
        titleAlign: 'center'
