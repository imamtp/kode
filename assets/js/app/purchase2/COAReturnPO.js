//acc list
Ext.define('GridCOAReturnPOPopup', {
    itemId: 'GridCOAReturnPOPopup',
    id: 'GridCOAReturnPOPopup',
    extend: 'Ext.grid.Panel',
    alias: 'widget.GridCOAReturnPOPopup',
    ...
    columns: [
    {
            ...
            handler: function(grid, rowIndex, colIndex, actionItem, event, selectedRecord, row) {
               setValueAcc(selectedRecord,'COAReturnPO','_coa_retur_po');
            }
        },
...
Ext.define(dir_sys + 'purchase2.COAReturnPO', {
    extend: 'Ext.window.Window',
    id: 'COAReturnPO',
    alias: 'widget.COAReturnPO',
    title: 'Pilih Akun',
    header: {
        titlePosition: 2,
        titleAlign: 'center'
